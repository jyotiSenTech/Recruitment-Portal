!(function (e, t) {
                        ...
                        for (t in e)
                            (i = o[t]),
                                ...
                                o !== n &&
                                    (u &&
                                    n &&
                                    (E.isPlainObject(n) || (r = E.isArray(n)))
                                        ? ((i = r
                                              ? ((r = !1),
                                                i && E.isArray(i) ? i : [])
                                              : i && E.isPlainObject(i)
    ...
    var b = (function (n) {
        ...
        try {
            F.apply((t = O.call(y.childNodes)), y.childNodes),
            ...
            if (
                ...
                if (11 !== p && (u = Z.exec(e)))
                    if ((i = u[1])) {
                        ...
                        if (u[2])
                            return F.apply(n, t.getElementsByTagName(e)), n;
                        if (
                            (i = u[3]) &&
            ...
            return (
                ...
                ae(function (e, t, n, r) {
                    var i,
                        ...
                        p = g ? (v || (e ? d : l || m) ? [] : t) : f;
                    if ((g && g(f, p, n, r), m))
                        for (i = ye(p, u), m(i, [], n, r), o = i.length; o--; )
                            (s = i[o]) && (p[u[o]] = !(f[u[o]] = s));
                    if (e) {
                        if (v || d) {
                            if (v) {
                    ...
                    } else (p = ye(p === t ? p.splice(l, p.length) : p)), v ? v(null, t, p, r) : F.apply(t, p);
                })
            );
        }
        function be(m, v) {
    ...
    function M(e, t, n) {
        var r;
        try {
            e && E.isFunction((r = e.promise))
                ? r.call(e).done(t).fail(n)
                : e && E.isFunction((r = e.then))
                ? r.call(e, t, n)
                : t.call(void 0, e);
        } catch (e) {
            n.call(void 0, e);
    ...
    (E.Callbacks = function (r) {
        ...
        E.extend({
                        ...
                        then: function (t, n, r) {
                            ...
                            return E.Deferred(function (e) {
                                o[0][3].add(
                                    ...
                                    o[1][3].add(
                                        l(0, e, E.isFunction(t) ? t : P)
                                    ),
                                    o[2][3].add(
                                        l(0, e, E.isFunction(n) ? n : R)
                                    );
                            }).promise();
                        },
                        promise: function (e) {
            ...
            when: function (e) {
                ...
                if (
                    n <= 1 &&
                    (M(e, s.done(t(r)).resolve, s.reject),
                ...
                if (
                    ...
                    for (t = s.length; t--; )
                        s[t] &&
                            ...
                            ((r = E.camelCase(r.slice(5))), Y(o, r, i[r]));
    ...
    function ee(e, t, n, r) {
        var i,
            ...
            c = (E.cssNumber[t] || ("px" !== l && +u)) && J.exec(E.css(e, t));
        if (c && c[3] !== l)
            for (
                l = l || c[3], n = n || [], c = +u || 1;
                (o = o || ".5"),
    ...
    function ce(e, t, n, r, i) {
        ...
        for (c.textContent = "", p = 0; (o = f[p++]); )
            if (r && -1 < E.inArray(o, r)) i && i.push(o);
                ...
                (s = ae(c.appendChild(o), "script")),
                u && ue(s),
                n)
            )
                for (l = 0; (o = s[l++]); ) oe.test(o.type || "") && n.push(o);
        return c;
    }
    ...
    function Ee(e, t) {
        return (
            (E.nodeName(e, "table") &&
                E.nodeName(11 !== t.nodeType ? t : t.firstChild, "tr") &&
    ...
    function Se(e, t) {
        ...
        if (1 === t.nodeType) {
            ...
            U.hasData(e) &&
                ((e = U.access(e)), (e = E.extend({}, e)), U.set(t, e));
        }
    }
    function De(n, r, i, o) {
        r = g.apply([], r);
        var e,
            ...
            d = r[0],
            h = E.isFunction(d);
        if (h || (1 < f && "string" == typeof d && !m.checkClone && we.test(d)))
            return n.each(function (e) {
                var t = n.eq(e);
                h && (r[0] = d.call(this, e, t.html())), De(t, r, i, o);
            });
        if (
            f &&
            ((t = (e = ce(r, n[0].ownerDocument, !1, n, o)).firstChild),
            1 === e.childNodes.length && (e = t),
            t || o)
        ) {
            for (a = (s = E.map(ae(e, "script"), ke)).length; c < f; c++)
                (u = e),
                    c !== p &&
                        ((u = E.clone(u, !0, !0)),
                        a && E.merge(s, ae(u, "script"))),
                    i.call(n[c], u, c);
            if (a)
                for (
                    ...
                    (u = s[c]),
                        oe.test(u.type || "") &&
                            ...
                            (u.src
                                ...
                                : v(u.textContent.replace(Ce, ""), l));
        }
        return n;
    }
    function je(e, t, n) {
        for (var r, i = t ? E.filter(t, e) : e, o = 0; null != (r = i[o]); o++)
            n || 1 !== r.nodeType || E.cleanData(ae(r)),
                r.parentNode &&
                    (n && E.contains(r.ownerDocument, r) && ue(ae(r, "script")),
    ...
    E.extend({
        ...
        clone: function (e, t, n) {
            ...
            if (
                ...
                for (s = ae(c), r = 0, i = (o = ae(e)).length; r < i; r++)
                    (a = o[r]),
                        (u = s[r]),
                        (l = void 0),
            ...
            if (t)
                if (n)
                    for (
                        o = o || ae(e), s = s || ae(c), r = 0, i = o.length;
                        r < i;
                        r++
                    )
                        Se(o[r], s[r]);
    ...
    function Ie() {
        ...
        Oe &&
            ...
            (Oe.innerHTML = ""),
            fe.appendChild(Fe),
            (e = T.getComputedStyle(Oe)),
            (Ae = "1%" !== e.top),
            (He = "2px" === e.marginLeft),
            (qe = "4px" === e.width),
            (Oe.style.marginRight = "50%"),
            (Le = "4px" === e.marginRight),
            fe.removeChild(Fe),
            (Oe = null));
    }
    function We(e, t, n) {
    ...
    function Ye(e, t, n, r, i) {
        for (
            ...
            "margin" === n && (o += E.css(e, n + K[s], !0, i)),
                r
                    ? ("content" === n &&
                          (o -= E.css(e, "padding" + K[s], !0, i)),
                      "margin" !== n &&
                          (o -= E.css(e, "border" + K[s] + "Width", !0, i)))
                    : ((o += E.css(e, "padding" + K[s], !0, i)),
                      "padding" !== n &&
                          (o += E.css(e, "border" + K[s] + "Width", !0, i)));
        return o;
    ...
    function Qe(e, t, n) {
        ...
        if (
            ...
            if (
                (((r = We(e, t, o)) < 0 || null == r) && (r = e.style[t]),
                Re.test(r))
            )
                return r;
        ...
        return r + Ye(e, t, n || (s ? "border" : "content"), i, o) + "px";
    }
    ...
    E.extend({
        ...
        style: function (e, t, n, r) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                var i,
                    ...
                    u = e.style;
                return (
                    (t = E.cssProps[a] || (E.cssProps[a] = Ve(a) || a)),
        ...
        css: function (e, t, n, r) {
            var i,
                o = E.camelCase(t);
            return (
                (t = E.cssProps[o] || (E.cssProps[o] = Ve(o) || o)),
            ...
            (E.cssHooks[i + o] = {
                expand: function (e) {
                    for (
                        ...
                        n[i + K[t] + o] = r[t] || r[t - 2] || r[0];
                    return n;
                },
            }),
                Pe.test(i) || (E.cssHooks[i + o].set = Ge);
        }),
        E.fn.extend({
            css: function (e, t) {
                return _(
    ...
    var Ke,
        ...
        tt = /queueHooks$/;
    function nt() {
        Ze && (T.requestAnimationFrame(nt), E.fx.tick());
    }
    function rt() {
        return (
            T.setTimeout(function () {
    ...
    function st(i, e, t) {
        ...
        for (
            ...
            if ((n = st.prefilters[r].call(l, i, c, l.opts)))
                return (
                    E.isFunction(n.stop) &&
    ...
    (E.Animation = E.extend(st, {
        ...
        tweener: function (e, t) {
            for (
                var n,
                    r = 0,
                    i = (e = E.isFunction(e) ? ((t = e), ["*"]) : e.match(O))
                        .length;
                r < i;
                r++
            )
        ...
        (E.fx.start = function () {
            Ze =
                ...
                (T.requestAnimationFrame
                    ...
                    : T.setInterval(E.fx.tick, E.fx.interval));
        }),
        (E.fx.stop = function () {
            T.cancelAnimationFrame
                ? T.cancelAnimationFrame(Ze)
                : T.clearInterval(Ze),
                (Ze = null);
        }),
                    ...
                    return void 0 === e.getAttribute
                        ...
                        : ((1 === o && E.isXMLDoc(e)) ||
                              (i =
                                  ...
                                  (E.expr.match.bool.test(t) ? at : void 0)),
                          void 0 !== n
                              ? null === n
                ...
                if ("string" == typeof t && t)
                    for (e = t.match(O) || []; (n = this[a++]); )
                        if (
                            ...
                            for (o = 0; (i = e[o++]); )
                                r.indexOf(" " + i + " ") < 0 && (r += i + " ");
                            s !== (s = ft(r)) && n.setAttribute("class", s);
                        }
                return this;
            },
                        ...
                        for (
                            ...
                            if (
                                ...
                                (!t.parentNode.disabled ||
                                    !E.nodeName(t.parentNode, "optgroup"))
                            ) {
    ...
    (E.param = function (e, t) {
        ...
        var r,
            i = [];
        if (E.isArray(e) || (e.jquery && !E.isPlainObject(e)))
            E.each(e, function () {
            ...
            ajax: function (e, t) {
                ...
                function w(e, t, n, r) {
                    ...
                    p ||
                        ...
                        (b.statusText = (t || a) + ""),
                        r
                            ? v.resolveWith(g, [i, a, b])
                            : v.rejectWith(g, [b, a, o]),
                        b.statusCode(x),
                        (x = void 0),
                        d &&
    ...
    var Ot = { 0: 200, 1223: 204 },
        Pt = E.ajaxSettings.xhr();
    (m.cors = !!Pt && "withCredentials" in Pt),
        (m.ajax = Pt = !!Pt),
        E.ajaxTransport(function (i) {
            var o, s;
            if (m.cors || (Pt && !i.crossDomain))
                return {
                    send: function (e, t) {
                        var n,
                            r = i.xhr();
    ...
    E.ajaxSetup({
        ...
        (E.fn.load = function (e, t, n) {
            var r,
                ...
                a = e.indexOf(" ");
            return (
                -1 < a && ((r = ft(e.slice(a))), (e = e.slice(0, a))),
                E.isFunction(t)
                    ? ((n = t), (t = void 0))
        ...
        (E.offset = {
            setOffset: function (e, t, n) {
                ...
                "static" === a && (e.style.position = "relative"),
                    ...
                    E.isFunction(t) && (t = t.call(e, n, E.extend({}, o))),
            ...
            offset: function (t) {
                ...
                return r
                    ? r.getClientRects().length
                        ? (e = r.getBoundingClientRect()).width || e.height
                            ? ((r = It((n = r.ownerDocument))),
                              (n = n.documentElement),
                              {
